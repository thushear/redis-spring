...
public abstract class FrameworkServlet extends HttpServletBean{
    ...
    private WebApplicationContext createWebApplicationContext() throws ServletException {
        ...
        try {
            ...
            logger.warn("Servlet with name '" + getServletName() + "' loaded child context " + waca);
            if (this.publishContext) {
                ...
                logger.warn("Bound servlet's context in global ServletContext with name '" + attName + "'");
            }
            return waca;
        }
            ...
            logger.warn("createWebApplicationContext", mesg, ex);
            throw startupException;
        }
    }
