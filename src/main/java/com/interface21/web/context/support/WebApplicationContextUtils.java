...
public abstract class WebApplicationContextUtils {
     ...
     */
    protected final static Logger logger = LoggerFactory.getLogger(WebApplicationContextUtils.class.getName());
    ...
    public static WebApplicationContext getWebApplicationContext(ServletContext sc) throws ServletException {
        WebApplicationContext waca = (WebApplicationContext) sc.getAttribute(WebApplicationContext.WEB_APPLICATION_CONTEXT_ATTRIBUTE_NAME);
        if (waca == null) {
     ...
     */
    public static Object getConfigObject(ServletContext sc, String name, Class requiredClass, boolean allowNull)    throws ServletException {
